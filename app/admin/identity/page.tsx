...
export default async function IdentityAdminPage() {
  ...
  return <main className="min-h-screen bg-[radial-gradient(circle_at_5%_0%,_rgba(219,234,254,0.85),_transparent_30%),linear-gradient(180deg,_#f8fbff_0%,_#ffffff_55%,_#f8fafc_100%)] px-4 py-6 text-slate-950 sm:px-6 lg:px-8">
    <div className="mx-auto max-w-7xl">
      <nav className="mb-6 flex flex-wrap items-center justify-between gap-3 rounded-2xl border border-white bg-white/90 px-5 py-3 shadow-sm"><Link href="/home" className="font-black">DataNexus</Link><div className="flex gap-2 text-sm"><Link href="/admin" className="rounded-xl px-3 py-2 font-semibold text-slate-600 hover:bg-blue-50">Organization Admin</Link><Link href="/admin/project-roles" className="rounded-xl px-3 py-2 font-semibold text-slate-600 hover:bg-blue-50">Project Roles</Link><Link href="/admin/landing-pages" className="rounded-xl px-3 py-2 font-semibold text-slate-600 hover:bg-blue-50">Landing Pages</Link></div></nav>
