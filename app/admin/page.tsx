...
export default async function AdminPage() {
  ...
  const superAdminOrganizationIds=await dataGovernanceSuperAdminOrganizationIds(user.id)
  const canCleanup=superAdminOrganizationIds.length>0
