...
export default async function ProjectRolesPage(){
  ...
  if(!orgIds.length)return <main className="min-h-screen bg-slate-50 p-6"><div className="mx-auto max-w-4xl rounded-3xl border bg-white p-8 shadow-sm"><ShieldCheck className="h-8 w-8 text-amber-600"/><h1 className="mt-4 text-2xl font-black">Project governance roles</h1><p className="mt-2 text-slate-600">Organization OWNER or ADMIN access is required.</p><Link href="/home" className="mt-5 inline-block font-bold text-blue-600">Return home</Link></div></main>
