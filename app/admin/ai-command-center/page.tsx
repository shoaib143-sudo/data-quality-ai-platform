    ...
    <div className="mx-auto max-w-7xl space-y-7">
      ...
      {!state || !learning || !learningLifecycle || !pgcl ? <section className="rounded-2xl border bg-white p-6 text-sm text-slate-600">No authorized project is available for this account.</section> : <>
        <section className="grid gap-4 sm:grid-cols-2 lg:grid-cols-10">
          ...
          <article className="rounded-2xl border bg-white p-5"><Activity className="h-5 w-5"/><p className="mt-3 text-3xl font-black">{state.counts.aiEvaluationResults}</p><p className="text-xs font-bold uppercase text-slate-500">Evaluations</p></article>
          <article className="rounded-2xl border bg-white p-5"><Activity className="h-5 w-5"/><p className="mt-3 text-3xl font-black">{learning.verifiedOutcomeCandidates.length + learning.semanticMemories.length}</p><p className="text-xs font-bold uppercase text-slate-500">Learning candidates</p></article>
          <article className="rounded-2xl border bg-white p-5"><ShieldCheck className="h-5 w-5"/><p className="mt-3 text-3xl font-black">{state.counts.routingPolicyVersions}</p><p className="text-xs font-bold uppercase text-slate-500">Routing policies</p></article>
          <article className="rounded-2xl border bg-white p-5"><AlertTriangle className="h-5 w-5"/><p className="mt-3 text-3xl font-black">{state.counts.investigations}</p><p className="text-xs font-bold uppercase text-slate-500">Investigations</p></article>
