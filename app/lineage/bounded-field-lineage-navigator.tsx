...
export function BoundedFieldLineageNavigator({projects}:{projects:Project[]}){
  ...
  return <>
    <button type="button" onClick={()=>setOpen(true)} className="fixed bottom-20 right-4 z-40 inline-flex max-w-[calc(100vw-2rem)] items-center gap-2 rounded-full border border-blue-200 bg-blue-700 px-4 py-3 text-sm font-black text-white shadow-xl shadow-blue-200/60 transition hover:bg-blue-800 sm:bottom-6 sm:right-48"><Columns3 className="h-4 w-4"/>Field lineage</button>
