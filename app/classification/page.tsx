...
export default async function ClassificationPage(){
  ...
  const policyCapability=await Promise.all(projectRows.map(async project=>[project.id,await hasProjectCapability(user.id,project.id,'policy.approve')] as const))
