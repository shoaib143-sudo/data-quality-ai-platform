...
export default async function CatalogPage(){
  ...
  return <main className="min-h-screen bg-slate-50 text-slate-950"><div className="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
    <nav className="mb-6 flex items-center justify-between rounded-2xl border bg-white px-5 py-3 shadow-sm"><Link href="/dashboard" className="flex items-center gap-3 font-bold"><span className="grid h-9 w-9 place-items-center rounded-xl bg-blue-600 text-white"><Layers3 className="h-5 w-5"/></span>Data Governance PowerHouse</Link><div className="flex flex-wrap gap-2 text-sm"><Link href="/catalog/discovery" className="rounded-xl px-3 py-2 font-semibold hover:bg-slate-100">Discovery</Link><Link href="/catalog/physical-assets" className="rounded-xl px-3 py-2 font-semibold hover:bg-slate-100">Physical Assets</Link><Link href="/glossary" className="rounded-xl px-3 py-2 font-semibold hover:bg-slate-100">Glossary</Link><Link href="/stewardship" className="rounded-xl px-3 py-2 font-semibold hover:bg-slate-100">Stewardship</Link><Link href="/lineage" className="rounded-xl px-3 py-2 font-semibold hover:bg-slate-100">Lineage</Link></div></nav>
