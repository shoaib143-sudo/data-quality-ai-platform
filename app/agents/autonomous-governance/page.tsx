  ...
  return (
    <main id="main-content" tabIndex={-1} className="min-h-screen p-6 md:p-8">
      <div className="mx-auto max-w-6xl space-y-6">
        <GlobalUtilityBar persona={landing.persona} organizationRole={landing.organizationRole} roleLabel="Autonomous Governance" contextLabel="Governed orchestration controls" homeHref="/home" />
