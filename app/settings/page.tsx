    ...
    <main id="main-content" tabIndex={-1} className="min-h-screen px-4 py-5 text-slate-100 sm:px-6">
      ...
      <section className="dn-surface mx-auto mt-4 max-w-3xl p-5 sm:p-6">
        ...
        <div className="mt-4 grid gap-3 sm:grid-cols-2">
          <Link href="/profile" className="dn-inset dn-interactive p-4">
          ...
          {canMonitoring ? <Link href="/monitoring" className="dn-inset dn-interactive p-4"><p className="font-bold text-white">Job Monitor</p><p className="mt-1 text-sm leading-6 text-slate-400">Open execution monitoring without changing execution authority.</p></Link> : null}
        </div>
