...
export function EditSourceForm({ source }: Props) {
  ...
  const jdbcExample = source.connectionKind === 'postgresql'
    ? 'jdbc:postgresql://db.example.com:5432/postgres'
    : source.connectionKind === 'mysql'
      ? 'jdbc:mysql://mysql.example.com:3306/sales_db'
      : source.connectionKind === 'mssql'
        ? 'jdbc:sqlserver://sql.example.com:1433;databaseName=sales'
        : source.connectionKind === 'databricks'
          ? 'jdbc:databricks://workspace.cloud.databricks.com:443;httpPath=/sql/1.0/warehouses/...'
