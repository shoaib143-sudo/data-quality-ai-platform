    ...
    {availableProjects.length === 0 ? <p className="text-sm text-muted-foreground">No projects are available for dataset registration.</p> :
      <form onSubmit={submit} className="grid gap-4 md:grid-cols-2">
        ...
        <div className="rounded-lg border p-4 text-sm md:col-span-1">
          ...
          <p className="mt-1 text-xs text-muted-foreground">Upload from this computer to private project storage. The uploaded object is validated and selected as the source automatically.</p>
