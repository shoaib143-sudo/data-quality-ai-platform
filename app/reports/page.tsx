...
export default async function ReportsPage() {
  ...
  return <main id="main-content" tabIndex={-1} className="min-h-screen bg-[#061426] px-4 py-6 text-slate-100 sm:px-6 lg:px-8">
    <div className="mx-auto max-w-7xl">
      <GlobalUtilityBar contextLabel="Governance reporting" />
