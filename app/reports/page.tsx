...
export default async function ReportsPage() {
  ...
  return <main className="min-h-screen bg-[#061426] px-4 py-6 text-slate-100 sm:px-6 lg:px-8"><div className="mx-auto max-w-7xl">
    ...
    {rows.length?<ReportManager projects={rows} initialProjectId={preferredProjectId}/>:<section className="rounded-3xl border border-white/10 bg-[#0a1d33] p-8 text-sm text-slate-500 shadow-sm">No accessible projects are available for reporting.</section>}
  </div></main>
}
