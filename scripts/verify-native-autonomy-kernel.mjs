...
contains(kernel, "'COMPENSATION_TOOL'", 'compensation rollback strategy')
contains(kernel, "'ESCALATE_ONLY'", 'escalation-only rollback strategy')
contains(kernel, 'mutating tool requires rollback_strategy COMPENSATION_TOOL or ESCALATE_ONLY', 'mutation rollback contract fail closed')
