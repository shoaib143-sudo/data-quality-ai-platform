...
const checks = [
  ['global modernized canvas', css.includes('--dn-canvas: 11 20 34') && css.includes('#0b1422') && css.includes('.dn-page')],
  ...
  ['profile menu follows modernized navy theme', profile.includes("bg-[#102036]") && profile.includes('border-white/10')],
