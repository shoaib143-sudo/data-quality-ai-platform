...
assert.ok(datasets.includes('id="main-content"'), 'onboarding must expose the shared skip-link target')
assert.ok(explorer.includes('id="main-content"'), 'Profiling Explorer must expose the shared skip-link target')
assert.ok(monitoring.includes('id="main-content"'), 'Job Monitor must expose the shared skip-link target')
