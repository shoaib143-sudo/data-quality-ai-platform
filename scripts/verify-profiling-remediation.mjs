...
const checks = [
  ...
  ['app/api/profiling/remediation/verify/route.ts', /VERIFICATION_PROFILE_PENDING[\s\S]*VERIFICATION_PROFILE_RUNNING[\s\S]*verifyRemediationOutcome/, 'linked automatic verification routing'],
