...
const checks = [
  ...
  ['app/profiling/explorer/page.tsx', /profile_runs[\s\S]*summary/, 'profiling explorer loads persisted investigation summary'],
  ['app/profiling/explorer/page.tsx', /workflow_instances/, 'profiling explorer loads profile-run governance workflow'],
  ['app/profiling/explorer/page.tsx', /profiling_remediation_outcomes/, 'profiling explorer loads remediation outcome evidence'],
  ['app/profiling/explorer/page.tsx', /remediation_issue_ids/, 'profiling explorer resolves persisted remediation issue ids'],
  ['app/profiling/explorer/page.tsx', /from\('issues'\)/, 'profiling explorer loads exact remediation issue records'],
  ['app/profiling/explorer/page.tsx', /ProfilingGovernancePanel/, 'profiling explorer renders governed remediation panel'],
  ['app/profiling/profiling-governance-panel.tsx', /\/api\/profiling\/approval/, 'profiling explorer governed approval action'],
  ['app/profiling/profiling-governance-panel.tsx', /\/api\/profiling\/remediation'/, 'profiling explorer remediation tracking action'],
  ['app/profiling/profiling-governance-panel.tsx', /\/api\/profiling\/remediation\/verify/, 'profiling explorer verification action'],
  ['app/profiling/profiling-governance-panel.tsx', /\/api\/profiling\/remediation\/reprofile/, 'profiling explorer automatic verification retry action'],
  ['app/profiling/profiling-governance-panel.tsx', /Start governed approval/, 'profiling explorer approval control'],
  ['app/profiling/profiling-governance-panel.tsx', /Track remediation/, 'profiling explorer tracked remediation control'],
  ['app/profiling/profiling-governance-panel.tsx', /Check verification/, 'profiling explorer verification control'],
  ['app/profiling/profiling-governance-panel.tsx', /Retry automatic verification/, 'profiling explorer verification retry control'],
  ['app/profiling/profiling-governance-panel.tsx', /\/api\/issues\/\$\{issue\.id\}/, 'profiling explorer governed issue resolution action'],
  ['app/profiling/profiling-governance-panel.tsx', /resolutionEvidence[\s\S]*PROFILING_EXPLORER/, 'profiling explorer resolution evidence provenance'],
  ['app/profiling/profiling-governance-panel.tsx', /Resolve with evidence/, 'profiling explorer evidence-driven resolution control'],
  ['app/profiling/profiling-governance-panel.tsx', /allTrackedIssuesResolved[\s\S]*canCheckVerification/, 'profiling explorer blocks verification until remediation issues resolve'],
  ['app/profiling/profiling-governance-panel.tsx', /productionMutationPerformed/, 'profiling explorer non-destructive execution evidence'],
  ['app/profiling/profiling-governance-panel.tsx', /href="\/workflows"/, 'profiling explorer workflow navigation'],
