...
const checks = [
  ...
  ['app/workflows/workflow-manager.tsx', /allProfileIssuesResolved[\s\S]*canRetryAutomaticVerification[\s\S]*Retry automatic verification/, 'workflow exposes retry only after tracked remediation resolution'],
