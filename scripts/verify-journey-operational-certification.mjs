...
const checks = [
  ...
  ['V6 preserves unavailable live database evidence as NOT_MEASURED', v6.includes('Authenticated live database contracts') && v6.includes('Status: NOT_MEASURED in CI') && v6.includes('if [ -z "$NEXT_PUBLIC_SUPABASE_URL" ] || [ -z "$SUPABASE_SERVICE_ROLE_KEY" ]; then') && v6.includes('exit 0')],
