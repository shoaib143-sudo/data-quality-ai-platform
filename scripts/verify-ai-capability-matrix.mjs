...
requireText(migration, 'revoke all on function governance.generate_ai_capability_matrix(uuid) from public, anon', 'anonymous execution revocation')
requireText(migration, 'grant execute on function governance.generate_ai_capability_matrix(uuid) to authenticated, service_role', 'authenticated execution grant')
