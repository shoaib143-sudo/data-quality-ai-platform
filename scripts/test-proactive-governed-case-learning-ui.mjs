...
for (const invariant of ['isDataGovernanceSuperAdmin', 'loadPositiveLearningCaseAdminInbox', 'pendingLearningCases', '/admin/learning-cases', 'Review learning cases']) {
  assert.ok(agentsPage.includes(invariant), 'missing PGCL discoverability invariant: ' + invariant)
}
