...
const checks = [
  ...
  ['learning promotion requires verified outcome', outcomes.includes("outcome.verification_status !== 'VERIFIED'")],
  ['learning promotion requires source agent provenance', outcomes.includes("reason: 'SOURCE_AGENT_RUN_REQUIRED'")],
  ...
  ['learning case is stored as verified outcome context only', outcomes.includes("source_kind: 'AUTONOMY_ACTION_OUTCOME'") && outcomes.includes("decision_status: 'VERIFIED'") && outcomes.includes("outcome_status: 'VERIFIED'") && outcomes.includes("authority: 'VERIFIED_OUTCOME_CONTEXT_ONLY'")],
  ...
  ['rollback invalidates verified outcome', autonomy.includes('invalidateGovernedActionOutcome') && outcomes.includes("verification_status: 'UNKNOWN'")],
  ['rollback revokes promoted learning', outcomes.includes("status: 'REVOKED'") && outcomes.includes("outcome_status: 'UNKNOWN'")],
  ...
  ['outcome verification is an explicit API operation', route.includes("operation === 'VERIFY_OUTCOME'") && route.includes('verifyGovernedActionOutcome')],
  ['autonomy list exposes outcome state', autonomy.includes("from('autonomy_action_outcomes')") && autonomy.includes('outcomes: outcomes.data ?? []')],
]
