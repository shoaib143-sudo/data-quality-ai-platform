...
const checks = [
  ...
  [containsAll(files.semanticJobs, ['GOVERNANCE_EMBEDDING_URL', 'AI_GATEWAY_API_KEY', 'VERCEL_OIDC_TOKEN', "process.env.VERCEL === '1'"]), 'semantic job scheduling accepts custom or Vercel runtime provider'],
