...
const checks = [
  ...
  [
    containsAll(files.reindexRoute, ['reindexProjectSemanticCorpusWithRuntime'])
      && containsAll(files.semanticProjectRuntime, ['reindexProjectSemanticObjects', 'reindexProjectDocumentSemanticObjects', 'reindexProjectSemanticCorpus'])
      && containsAll(files.semanticProjectReindex, ['groups', 'governance', 'documents']),
    'combined governance and document semantic reindex',
  ],
