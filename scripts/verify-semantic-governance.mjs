...
const files = {
  ...
  governanceEmbeddingProvider: await readFile('lib/ai/governance-embedding-provider.ts', 'utf8'),
  ...
  semanticProjectRuntime: await readFile('lib/governance/semantic-project-reindex-runtime.ts', 'utf8'),
  semanticProjectReindex: await readFile('lib/governance/semantic-project-reindex.ts', 'utf8'),
...
const checks = [
  ...
  [containsAll(files.reindexRoute, ['reindexProjectSemanticCorpusWithRuntime', 'result.failed']), 'semantic reindex route delegates to the governed corpus runtime'],
  [containsAll(files.semanticProjectRuntime, ['reindexProjectSemanticObjects', 'reindexProjectDocumentSemanticObjects', 'reindexProjectSemanticCorpus']), 'semantic corpus runtime composes governance and document reindexers'],
  [containsAll(files.semanticProjectReindex, ['dependencies.governance', 'dependencies.documents', 'const groups = { governance, documents']), 'combined governance and document semantic reindex'],
