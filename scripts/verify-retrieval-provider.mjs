...
requireText(provider, 'withNormalizedRetrievalMetadata(metadata, normalizationNow)', 'normalized metadata preserved under strict retrieval modes')
...
execFileSync(process.execPath, ['--experimental-strip-types', 'scripts/test-retrieval-provider.mjs'], { stdio: 'inherit' })
console.log('ADR-006 RetrievalProvider authority, temporal, normalized metadata projection, dedicated RerankerProvider, and search integration contracts verified.')
