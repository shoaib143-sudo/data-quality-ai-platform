...
# agent authority/recursion boundaries, and migration integrity. Broader
# governance, profiling, recovery, and end-to-end certification remain in
# dedicated jobs or run automatically on the exact merged main SHA.
...
pnpm run verify:agent-excellence
