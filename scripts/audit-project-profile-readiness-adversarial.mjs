...
check('Admission migration remains separate from AI tool registration', !admissionMigration.includes("'remediate_profile_readiness'") && aiToolMigration.includes("'remediate_profile_readiness'"), 'Already-merged admission history must remain immutable; AI tool registration must be forward-only.')
...
check('AI remediation is a real governed agent path', aiToolMigration.includes("'remediate_profile_readiness'") && executor.includes("case 'remediate_profile_readiness'") && remediationApi.includes("step_name: 'remediate_profile_readiness'") && remediationApi.includes("executeProfilingExecutor(\n      'remediate_profile_readiness'"), 'The AI option must execute as an auditable profiling-agent tool rather than relabeled direct automation.')
