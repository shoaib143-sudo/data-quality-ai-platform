...
const requiredWorkflowPaths=[
  ...
  "'tests/ux-modernization-family-wave.test.mjs'",
  "'tests/ux-responsive-metric-grid.test.mjs'",
  "'tests/ux-modernization-negative-failure.test.mjs'",
  "'tests/data-360-connected-context.test.mjs'",
  "'tests/ai-ux-governance-context.test.mjs'",
  "'tests/ai-learning-governance-ux.test.mjs'",
  "'scripts/audit-ux-modernization-adversarial.mjs'"
]
...
const requiredSteps=[
  ...
  "Test all-page UX modernization coverage",
  "Test governed AI and Data 360 UX contracts",
  "Test modernization negative and failure cases",
  "Run independent modernization adversarial audit",
...
const requiredCommands=[
  ...
  "ux-all-pages-coverage.test.mjs",
  "ux-modern-design-system.test.mjs",
  "ux-modernization-family-wave.test.mjs",
  "ux-responsive-metric-grid.test.mjs",
  "data-360-connected-context.test.mjs",
  "ai-ux-governance-context.test.mjs",
  "ai-learning-governance-ux.test.mjs",
  "ux-modernization-negative-failure.test.mjs",
  "audit-ux-modernization-adversarial.mjs",
