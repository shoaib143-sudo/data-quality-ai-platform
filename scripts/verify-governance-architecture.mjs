...
const checks = [
  ...
  ['app/api/search/route.ts', /embedGovernanceText[\s\S]*semanticSearchByEmbedding[\s\S]*mergeResults[\s\S]*NOT_CONFIGURED[\s\S]*UNAVAILABLE/, 'hybrid lexical and semantic governance search'],
