...

{
  ...
  assert.equal(events[1].attributes.routing_policy_reason, null)
...
console.log('ADR-006 Intelligent Router route, routed policy/model identity, and sanitized model invocation telemetry behavior passed.')
