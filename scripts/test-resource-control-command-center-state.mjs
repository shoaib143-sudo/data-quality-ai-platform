...
assert.equal(state.controls.runtimeCostEnforcementEnabled, true)
...
console.log('Resource-control Command Center budget, admission, lease, pricing-authority, runtime-cost, and project readiness checks passed.')
