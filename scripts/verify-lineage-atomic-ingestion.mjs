...
requireText(lineageEnrichment, "['system.access.column_lineage', 'system.access.table_lineage']", 'authoritative Databricks table/column provenance allowlist')
requireText(lineageEnrichment, 'lacks authoritative system.access provenance.', 'non-authoritative Databricks lineage rejection')
requireText(lineageEnrichment, 'lacks system.access.column_lineage provenance.', 'field mappings require column-lineage provenance')
...
requireText(lineageEnrichment, 'Databricks lineage ingestion requires the accountable Web UI discovery actor.', 'accountable Web UI actor requirement')
requirePattern(lineageEnrichment, /transformations = inputTransformations\.filter\(item => !governedSet\.has\(item\)\)/, 'authoritative Databricks transformations excluded from legacy direct persistence')
requirePattern(lineageEnrichment, /authoritative_source:\s*'system\.access\.column_lineage'/, 'governed field mapping provenance preservation')
