...
requireText("authorizeProject(user.id,projectId,'lineage.read')",'central read authorization before suggestion listing')
requireText("authorizeProject(user.id,projectId,'lineage.manage')",'central mutation authorization before suggestion generation/review/promotion')
requireText('authorizationErrorResponse','JSON-safe central authorization failures')
