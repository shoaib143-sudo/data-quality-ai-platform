...
begin
  ...
  v_app_private_exposed := coalesce('app_private'=any(string_to_array(v_schema_setting,',')),false);
  v_governance_exposed := coalesce('governance'=any(string_to_array(v_schema_setting,',')),false);
  v_orchestration_exposed := coalesce('orchestration'=any(string_to_array(v_schema_setting,',')),false);
