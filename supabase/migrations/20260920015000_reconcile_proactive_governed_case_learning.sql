-- Forward-only reconciliation for the immutable historical PGCL migration.
-- Reissues the full idempotent Phase 11 PGCL contract with valid dollar quoting.
-- The released 20260920014000 file remains untouched.
