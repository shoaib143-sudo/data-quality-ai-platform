...
- **Branch protection:** `main` protected with required GitHub Actions contexts `build`, `analyze`, `revalidate`, `certify`, and `release-governance`; squash merge and linear-history policy remain enforced.
