...
- Production migration history does not yet contain the glossary hardening migration, so the production direct-write boundary remains BLOCKED for certification until deployment is independently verified. No production migration was applied from this testing flow.
