...
export const GOVERNED_AGENT_POLICIES: Record<GovernedAgentKey, GovernedAgentPolicy> = {
  ...
  steward_agent: {
    ...
    requiresHumanApprovalForGovernanceMutation: true,
    toolAllowlist: ['governance_specialist_investigate', 'governance.dataset.read', 'governance.glossary.read', 'governance.cde.read', 'governance.classification.read', 'governance.stewardship.read'],
  ...
  governance_analyst_agent: {
    ...
    mutationBoundary: 'READ_ONLY',
    requiresHumanApprovalForGovernanceMutation: true,
    toolAllowlist: ['governance_specialist_investigate', 'governance.dataset.read', 'governance.policy.read', 'governance.control.read', 'governance.contract.read', 'governance.risk.read', 'lineage.read'],
  ...
  architect_agent: {
    ...
    mutationBoundary: 'READ_ONLY',
    requiresHumanApprovalForGovernanceMutation: true,
    toolAllowlist: ['governance_specialist_investigate', 'catalog.read', 'lineage.read', 'contracts.read', 'profiling.history.read', 'governance.cde.read'],
  ...
  investigator_agent: {
    ...
    mutationBoundary: 'READ_ONLY',
    requiresHumanApprovalForGovernanceMutation: true,
    toolAllowlist: ['governance_specialist_investigate', 'quality.incident.read', 'quality.history.read', 'profiling.history.read', 'lineage.read', 'governance.issue.read', 'remediation.history.read'],
  ...
  executive_agent: {
    ...
    mutationBoundary: 'READ_ONLY',
    requiresHumanApprovalForGovernanceMutation: true,
    toolAllowlist: ['governance_specialist_investigate', 'governance.scorecard.read', 'governance.risk.read', 'governance.certification.read', 'quality.summary.read', 'governance.control.read'],
  ...
  support_agent: {
    ...
    mutationBoundary: 'READ_ONLY',
    requiresHumanApprovalForGovernanceMutation: true,
    toolAllowlist: ['governance_specialist_investigate', 'profiling.history.read', 'quality.incident.read', 'governance.issue.read', 'remediation.history.read', 'lineage.read'],
