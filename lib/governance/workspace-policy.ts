...
const access: Record<PersonaSlug, readonly WorkspaceKey[]> = {
  ...
  'data-owner': ['account', 'catalog', 'discovery', 'glossary', 'data-quality', 'stewardship', 'issues', 'lineage', 'lineage-manage', 'reports', 'classification', 'profiling', 'monitoring', 'agents', 'contracts', 'scorecards', 'workflows', 'search', 'inbox', 'journeys'],
  ...
  'data-steward': ['account', 'catalog', 'discovery', 'glossary', 'data-quality', 'stewardship', 'issues', 'lineage', 'lineage-manage', 'classification', 'reports', 'profiling', 'monitoring', 'agents', 'contracts', 'scorecards', 'workflows', 'search', 'inbox', 'journeys'],
