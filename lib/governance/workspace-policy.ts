...
const access: Record<PersonaSlug, readonly WorkspaceKey[]> = {
  'senior-leadership': ['catalog', 'issues', 'data-quality', 'stewardship', 'reports', 'profiling', 'monitoring', 'scorecards', 'search', 'inbox', 'journeys'],
  'business-user': ['catalog', 'glossary', 'issues', 'data-quality', 'profiling', 'monitoring', 'search', 'inbox', 'journeys'],
  'data-owner': ['catalog', 'discovery', 'glossary', 'data-quality', 'stewardship', 'issues', 'lineage', 'lineage-manage', 'reports', 'classification', 'profiling', 'monitoring', 'contracts', 'scorecards', 'workflows', 'search', 'inbox', 'journeys'],
  'data-product-owner': ['catalog', 'glossary', 'lineage', 'stewardship', 'issues', 'data-quality', 'reports', 'profiling', 'monitoring', 'contracts', 'scorecards', 'workflows', 'search', 'inbox', 'journeys'],
  'data-steward': ['catalog', 'discovery', 'glossary', 'data-quality', 'stewardship', 'issues', 'lineage', 'lineage-manage', 'classification', 'reports', 'profiling', 'monitoring', 'contracts', 'scorecards', 'workflows', 'search', 'inbox', 'journeys'],
  'data-governance-specialist': ['catalog', 'glossary', 'lineage', 'stewardship', 'classification', 'issues', 'data-quality', 'audit', 'reports', 'ai-capabilities', 'retention', 'profiling', 'monitoring', 'contracts', 'scorecards', 'workflows', 'search', 'inbox', 'journeys'],
  'compliance-risk-officer': ['catalog', 'glossary', 'lineage', 'classification', 'issues', 'data-quality', 'audit', 'reports', 'retention', 'profiling', 'monitoring', 'contracts', 'documents', 'scorecards', 'workflows', 'search', 'inbox', 'journeys'],
  'privacy-security-officer': ['catalog', 'glossary', 'lineage', 'classification', 'classification-privacy', 'issues', 'audit', 'reports', 'profiling', 'monitoring', 'documents', 'workflows', 'search', 'inbox', 'journeys'],
  ...
  'metadata-analyst': ['catalog', 'glossary', 'lineage', 'classification', 'issues', 'data-quality', 'audit', 'reports', 'ai-capabilities', 'profiling', 'monitoring', 'contracts', 'documents', 'scorecards', 'search', 'inbox', 'journeys'],
  'data-quality-analyst': ['catalog', 'issues', 'data-quality', 'monitoring', 'observability', 'audit', 'reports', 'ai-capabilities', 'profiling', 'agents', 'contracts', 'documents', 'scorecards', 'workflows', 'search', 'inbox', 'journeys'],
}
